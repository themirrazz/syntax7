  ...
  json:function(code,f) {
    ...
    for(var i=0;i<code.length;i++) {
      if(doublestr) {
        ...
        } else  if(kwd('false',i)){format+="<span class='kw8'>";format+=Syntax7.util.escape(ts.slice(i,i+1))
          ki="false"
        } else if(ki=="false") {
          if(kw=="false") {
            ki=""
        ...
        } else  if(kwd('true',i)){format+="<span class='kw8'>";format+=Syntax7.util.escape(ts.slice(i,i+1))
          ki="true"
        } else if(ki=="true") {
          if(kw=="true") {
            ki=""
  ...
  util: {
    ...
    from:function(raw,language) {
      switch (language) {
        ...
        case "md":
          return Syntax7.md(raw)
        case "json":
          return Syntax7.json(raw)
        default:
